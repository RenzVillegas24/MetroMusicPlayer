...
namespace Metro.Custom
{
    ...
    public class CircularLoader : Control
    {
        ...
        public static readonly DependencyProperty IsActiveProperty = DependencyProperty.Register("IsActive",
                                                                                        ...
                                                                                        FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, IsActiveChanged));
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(CircularLoader), new FrameworkPropertyMetadata(typeof(CircularLoader)));
        }
        ...
        {
            var ring = dependencyObject as CircularLoader;
